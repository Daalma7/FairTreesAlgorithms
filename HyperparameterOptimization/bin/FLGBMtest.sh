...
python main.py nind=200 ngen=2 alg=nsga2 dat=adult var=race bseed=100 nruns=10 model=FLGBM obj=gmean_inv,dem_fpr &
#python main.py nind=200 ngen=300 alg=nsga2 dat=german var=age bseed=100 nruns=10 model=FLGBM obj=gmean_inv,dem_fpr &
#python main.py nind=200 ngen=300 alg=nsga2 dat=propublica_recidivism var=race bseed=100 nruns=10 model=FLGBM obj=gmean_inv,dem_fpr &
#python main.py nind=200 ngen=300 alg=nsga2 dat=propublica_violent_recidivism var=race bseed=100 nruns=10 model=FLGBM obj=gmean_inv,dem_fpr &
#python main.py nind=200 ngen=300 alg=nsga2 dat=ricci var=Race bseed=100 nruns=10 model=FLGBM obj=gmean_inv,dem_fpr &
